package com.kerwin.ac.trie;

import com.kerwin.ac.interval.IntervalTree;
import com.kerwin.ac.interval.Intervalable;
...
public class Trie {
     ...
     * 字符串集合构建一棵树
     */
    public static Trie compile (List<String> list) {
